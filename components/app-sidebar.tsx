                    ...
                    <div className="space-y-2 h-full overflow-y-auto overflow-x-hidden">
                      {isLoadingChatHistory ? (
                        <div className="flex items-center justify-center py-6">
                          ...
                          <span className="ml-2 text-xs text-gray-300">Loading conversations...</span>
                        </div>
                        ...
                        <div className="text-center py-6">
                          <div className="w-10 h-10 mx-auto mb-2 bg-white border border-gray-300 rounded-full flex items-center justify-center">
                            <MessageSquare className="h-5 w-5 text-gray-400" />
                          </div>
                          <p className="text-xs text-gray-300 mb-1">No conversations yet</p>
